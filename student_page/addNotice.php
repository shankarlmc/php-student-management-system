...
if (isset($_POST['save'])) { // if save button on the form is clicked
    ...
    if(empty($title)){
         $errors[] = "Notice Title Should Not Be Empty !!!!!";
      }
      if(empty($content)){
    ...
    if(empty($errors)==true) {
        ...
        move_uploaded_file($file, $destination);
            ...
            if (mysqli_query($conn, $sql)) {
                echo "<h4><span class='alert alert-success'>Notice Inserted successfully !!!!!</span></h4><br>";
        } else{
...
<div class="container">
  <div class="row">
    <div class="col-md-7"> 
    <h1 class="font-weight-bold w-100" style="">Wants to add Notice</h1><br>
